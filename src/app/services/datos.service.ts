...
export class DatosService {
  ...
  service_general_post(url, parametros): Observable<any> {
    return this.http.post(this.url + url, parametros, { headers: this._headers });
  }

  service_general_get(url): Observable<any> {
    return this.http.get(this.url + url, { headers: this._headers });
  }

  service_general_params_get(url, parametros): Observable<any> {
    return this.http.get(this.url + url, { headers: this._headers, params: parametros });
  }
